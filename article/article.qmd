...
<img src="../docs/identifier_color.png" alt="Acronym Logo" style="display: block; margin-left: 0; width: 40%;" />
...
::: {layout-nrow=2}
![A demographic dividend framework *(Cardona et al, 2020)*](../docs/dividends_frmwk.jpeg){fig-align="center" width=700}

![Potential sector-specific programs and interventions *(Cardona et al., 2020)*](../docs/prosperity_wheel.jpeg){fig-align="center" width=600}
:::
